...
RUN STATIC=$(python -c "import streamlit, os; print(os.path.join(os.path.dirname(streamlit.__file__), 'static'))") \
    && sed -i 's|<title>Streamlit</title>|<title>Facility Location</title>|' "$STATIC/index.html" \
    && sed -i 's|</head>|<link rel="icon" type="image/png" href="./favicon.png"/><meta property="og:type" content="website"/><meta property="og:title" content="Facility Location MIP Optimizer"/><meta property="og:description" content="Uncapacitated facility location: choose sites to open and serve every customer at minimum cost. Pyomo + Gurobi, runs in your browser."/><meta property="og:image" content="https://griffith-pse.com/images/facility-location.png"/><meta property="og:site_name" content="Griffith PSE"/><meta name="twitter:card" content="summary_large_image"/><meta name="twitter:title" content="Facility Location MIP Optimizer"/><meta name="twitter:description" content="Uncapacitated facility location: choose sites to open and serve every customer at minimum cost. Pyomo + Gurobi, runs in your browser."/><meta name="twitter:image" content="https://griffith-pse.com/images/facility-location.png"/></head>|' "$STATIC/index.html" \
