...
with _caption_col:
    st.markdown(
        ...
        "to its nearest open facility (there are no capacity limits). On the "
        "map, site marker size scales with fixed cost and customer dot size "
        "with demand. Toggle sites open on the map and watch your cost, then "
